...
public class ConfigureASystem {
    ...
    public static EcoSystem configure(){
        ...
        UserAccount uc1 = system.getUserAccountDirectory().createUserAccount("1", "1", new CustomerRole());
        ...
        w1.setRestaurant(r1);
        w1.setFood(f1);
        w1.setMessage("satisfactory");
        w1.setStatus("delivered");
